...
gcloud run deploy brawlmanager-backend --image gcr.io/brawlmanager/brawlmanager-backend --add-cloudsql-instances brawlmanager:us-central1:brawlmanager-db --platform managed --region us-central1 --env-vars-file .env --allow-unauthenticated
